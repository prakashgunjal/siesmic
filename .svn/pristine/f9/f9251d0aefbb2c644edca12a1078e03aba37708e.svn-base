...
<script type="text/javascript" src="account/accountmenu.js"></script>

<script type="text/javascript" src="../gridjs/accounts-grid.js"></script>
<style type="text/css">
.editedRow {
	color: #b90f0f;
	font-style: italic;
							...
							<div class="row-fluid">
								<div class="span12" style="margin-left: 0px; margin-top: 5px;">
									<div id='jqxWidget'>
										<div style='float: left; margin-left: 0px; margin-top: -5px;'
											...
											<ul style="margin-left: 30px;">
												...
												<li><a
													href="${pageContext.request.contextPath}/crm/opportunity/viewOpportunities.htm">Opportunities</a></li>
									...
									$(document).ready(function () {
										...
										// Create a jqxMenu
										$("#accmenu").jqxMenu({ width: '99.8%', height: '30px', theme: theme });
										$("#accmenu").css('visibility', 'visible');    
									});
								</script>
													<div id='jqxWidget' style='margin-top: 0px;'>
														<div id='accmenu' style='visibility: hidden;'>
															<ul>
																<li><img src="../image/plus.png"
																	style="height: 20px; width: 20px;" /><a
																	href="account/createditaccounts.jsp" target="_newcrm">&nbsp;Account</a></li>
															</ul>
														</div>
														<br />
													</div>
												...
												<div id="accountsgrid" style="margin-top: -15px;"></div>
