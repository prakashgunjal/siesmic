         ...
         $(document).ready(function () {
            ...
            $("#warehousegrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Purchase Order name', editable: false, datafield: 'poname', width: 200, rendered: tooltiprenderer },
                  { text: 'Purchase Order Number', editable: false, datafield: 'ponum', width: 200, rendered: tooltiprenderer },
                  { text: 'Purchase Order Date', editable: false, datafield: 'podate', width: 200, rendered: tooltiprenderer },
                  { text: 'Sales Rep', editable: false, datafield: 'salesrep', width: 200, rendered: tooltiprenderer },
                  { text: 'Priority', editable: false, datafield: 'popriority',width: 200, rendered: tooltiprenderer},
				  { text: 'Status', editable: false, datafield: 'postatus', width: 200, rendered: tooltiprenderer }
