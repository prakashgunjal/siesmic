...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="prod-subcateg-form.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="../productsubcategory.jsp">Products Sub-Category</a></li>
			<li><a href="#">New Product Sub-Category</a></li>
        </ul>
