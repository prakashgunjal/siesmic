...
(function ($) {
    ...
    $.extend($.jqx._jqxPasswordInput.prototype, {
        ...
        defineInstance: function () {
            ...
            this.localization = { passwordStrengthString: "Password strength", tooShort: "Too short", weak: "Weak", fair: "Fair", good: "Good", strong: "Strong" };
        ...
        _setAttributes: function () {
            ...
            this.addHandler(widget, 'focus.passwordinput' + this.widgetID, function () {
                ...
                if (me.placeHolder && me.browserCheck && !("placeholder" in me.element) && widget.val() == me.placeHolder) {
                    widget.val("");
                    if (me._hidden == true) {
                        widget.attr("type", "password");
                    };
                };
                if (me.showPasswordIcon == true && me.browserCheck) {
                    if (me.rtl == false) {
            ...
            this.addHandler(widget, 'blur.passwordinput' + this.widgetID, function () {
                ...
                if (me.placeHolder && me.browserCheck && !("placeholder" in me.element) && widget.val() == "") {
            ...
            if (this.showPasswordIcon == true && this._browserCheck) {
                ...
                var toggle = function () {
                    if (me._hidden == false) {
                        ...
                        me._hidden = false;
                        icon.attr("title", me.localization.hidePasswordString);
                    }
                }
        ...
        _positionIcon: function()
        {
            ...
            if (this.rtl == true) {
                this.icon.offset({ top: hostOffset.top + h / 2 - 9 / 2, left: hostOffset.left + 2 });
            } else {
                this.icon.offset({ top: hostOffset.top + h / 2 - 9 / 2, left: hostOffset.left + w - 18 });
            };
        },
