...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/producttypemenu.js"></script>
	
	
	<script type="text/javascript" src="producttype/prodtypegrid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='prodtypemenu'>
            <ul>
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='warehousedepot' style='visibility: hidden;'>
												<ul>
													<li>
														<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="producttype/createditproducttype.jsp" target="_newtab">&nbsp;New Product Type</a>
													</li>
												</ul>
											</div>
											<br/>
