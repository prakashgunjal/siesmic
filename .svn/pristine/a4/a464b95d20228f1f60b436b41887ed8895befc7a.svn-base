...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/purchaseordermenu.js"></script>
	
	
	<script type="text/javascript" src="purchaseorder/purchaseorder-grid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='pomenu'>
            <ul>
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='invrecp' style='visibility: hidden;'>
												<ul>
													<li>
														<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="purchaseorder/createditpurchaseorder.jsp" target="_newtab">&nbsp;Purchase Order</a>
													</li>
