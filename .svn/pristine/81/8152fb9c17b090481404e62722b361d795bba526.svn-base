...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/productbundlemenu.js"></script>
	
	
	<script type="text/javascript" src="productbundle/prodbundlegrid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='prodbundle'>
            <ul>
				...
				<li><a href="#" title="">Product Bundle</a></li>
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='warehousedepot' style='visibility: hidden;'>
												<ul>
													<li>
														<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="productbundle/createditproductbundle.jsp" target="_newtab">&nbsp;Product Bundle</a>
													</li>
												</ul>
											</div>
											<br/>
