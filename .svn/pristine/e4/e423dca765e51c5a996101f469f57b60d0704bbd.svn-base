...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/productsubcategorymenu.js"></script>
	
	
	<script type="text/javascript" src="productsubcategory/prodsubcategorygrid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='prodsubcategmenu'>
            <ul>
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='warehousedepot' style='visibility: hidden;'>
												<ul>
													<li>
															<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="productsubcategory/createditsubcat.jsp" target="_newtab">&nbsp; Sub-category</a>
													</li>
