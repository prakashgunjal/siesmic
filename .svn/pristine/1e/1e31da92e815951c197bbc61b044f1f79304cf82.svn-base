...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/assetmenu.js"></script>
	
	
	<script type="text/javascript" src="assetmoment/assetmovement-grid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='assetmomenu'>
            <ul>
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='invrecp' style='visibility: hidden;'>
												<ul>
													<li>
														<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="assetmoment/createditassetmovement.jsp" target="_newtab">&nbsp;Asset Movement</a>
													</li>
												</ul>
											</div>
											<br/>
