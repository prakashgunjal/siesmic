         ...
         $(document).ready(function () {
             ...
             var source =
            {
                ...
                datafields:
                [
                    { name: 'Locationsname', type: 'string' },
                    { name: 'sitename', type: 'string' },
                    { name: 'premisesname', type: 'date' },
                    { name: 'premiseswingname', type: 'date' },
					{ name: 'premiseslocation', type: 'string' }    
                ],
            ...
            $("#warehousegrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Location Name', editable: false, datafield: 'Locationsname', width: 240, rendered: tooltiprenderer },
                  { text: 'Site Name', editable: false, datafield: 'sitename', width: 200, rendered: tooltiprenderer },
                  { text: 'Premises Name', editable: false, datafield: 'premisesname', width: 200, rendered: tooltiprenderer },
                  { text: 'Premises Wing Name', editable: false, datafield: 'premiseswingname',width: 200, rendered: tooltiprenderer},
				  { text: 'Premises Location', editable: false, datafield: 'premiseslocation', width: 200, rendered: tooltiprenderer }
