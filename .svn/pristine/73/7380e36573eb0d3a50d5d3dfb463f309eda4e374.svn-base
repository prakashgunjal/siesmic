...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="projectmenujs/projectmenu.js"></script>

     <script type="text/javascript" src="../../extjs/include-ext.js"></script>

 
	<script type="text/javascript" src="project-form.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:5px;' id='projectmenu'>
            <ul>
            	<li>Alerts</li>
                <li>Tasks</li>
                <li>Calls</li>
