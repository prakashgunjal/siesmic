...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="contract/contractmenujs/contractmenu.js"></script>
	
	
	<script type="text/javascript" src="contract/contract-grid.js"></script>
...
<div id='jqxWidget'>
        <div style='float: left; margin-left:0px; margin-top:-5px;' id='contractmenu'>
            <ul style="margin-left: 30px;">
            	
                <li><a href="#">Contracts</a></li>
                <!-- <li><a href="contractrenewal.jsp">Contract Renewal</a></li> -->
            ...
            <div>
                 ...
                 <div id='content' style="margin-top:0px;">
								<script type="text/javascript">
									$(document).ready(function () {
										...
										// Create a jqxMenu
										$("#contractsmenu").jqxMenu({ width: '99.8%', height: '30px', theme: theme });
										$("#contractsmenu").css('visibility', 'visible');    
									});
								</script>
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='contractsmenu' style='visibility: hidden;'>
												<ul>
													<li><img src="../image/plus.png" style="height:20px; width:20px;"/><a href="contract/createditcontract.jsp" target="_newtab">&nbsp;Contract</a></li>
												</ul>
											</div>
											<br/>
										</div>
				...
				<div id="contragrid" style="margin-top:-15px;"></div>
            </div>
            <!-- <div>
