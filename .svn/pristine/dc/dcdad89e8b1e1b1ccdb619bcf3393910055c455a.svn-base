         ...
         $(document).ready(function () {
             ...
             var source =
            {
                ...
                datafields:
                [
                    { name: 'productsname', type: 'string' },
                    { name: 'productnum', type: 'date' },
                    { name: 'actualstockdate', type: 'string' },
            ...
            $("#warehousegrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Product Name', editable: false, datafield: 'productsname', width: 240, rendered: tooltiprenderer },
                  { text: 'Product Number', editable: false, datafield: 'productnum', width: 200, rendered: tooltiprenderer },
                  { text: 'Actual Stock Date', editable: false, datafield: 'actualstockdate', width: 200, rendered: tooltiprenderer },
                  { text: 'Location Name', editable: false, datafield: 'locationname',width: 200, rendered: tooltiprenderer},
