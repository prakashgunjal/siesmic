            ...
            for (var virtualItemIndex = startIndex; virtualItemIndex < this.virtualItemsCount; virtualItemIndex++) {
                ...
                if (this.checkboxes && this.host.jqxCheckBox) {
                 ...
                 //   itemElement.prepend(checkbox);
                    checkbox.jqxCheckBox({disabledContainer: true, hasInput: false, checked: item.checked, animationShowDelay: 0, animationHideDelay: 0, disabled: item.disabled, enableContainerClick: false, keyboardCheck: false, hasThreeStates: this.hasThreeStates, theme: this.theme });
                    ...
                    for (indx = 0; indx < this.visibleItems.length; indx++) {
                        ...
                        if (item.visibleIndex == index && !item.isGroup) {
                            ...
                            if (item.initialTop < value) {
                                ...
                                vScrollInstance.setPosition(item.initialTop + item.height + 2 - this.host.height());
                            }
