...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="inventoryreceiptmenu/inventoryreceiptmenu.js"></script>
	<script type="text/javascript" src="inventoryreceiptserialize-grid.js"></script>
    <script type="text/javascript" src="../../extjs/include-ext.js"></script>
   
 
	<script type="text/javascript" src="inventoryreceipt-form.js"></script>
	<script type="text/javascript" src="inventoryreceiptserialize-grid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="#">New inventory Receipts</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='inventoryreceiptmenu'>
            <ul>
