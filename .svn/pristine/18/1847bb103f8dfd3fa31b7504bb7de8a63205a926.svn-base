        ...
        _addfilterwidget: function (columnrecord, tablecolumn, width) {
            ...
            switch (columnrecord.filtertype) {
                case 'number':
                    ...
                    dropdownlist.jqxDropDownList({rtl: me.rtl, dropDownHorizontalAlignment: 'right', enableBrowserBoundsDetection: true, selectedIndex: selectedIndex, width: 18, height: 20, dropDownHeight: 80, dropDownWidth: 170, source: source, theme: me.theme });
