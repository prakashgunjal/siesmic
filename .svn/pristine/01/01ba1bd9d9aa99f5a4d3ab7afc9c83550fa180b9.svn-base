...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/pricelistmenu.js"></script>
	
	
	<script type="text/javascript" src="pricelist/pricelistgrid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='pricelistmenu'>
            <ul>
            	<li><a href="product.jsp" title="project">Product</a></li>
               	<li><a href="productcategory.jsp" title="project">Product Category</a></li>
				<li><a href="productsubcategory.jsp">Product Sub-Category</a></li>
				<li><a href="producttype.jsp">Product Type</a></li>
				<li><a href="productsubtype.jsp">Product Sub-Type</a></li>
				<li><a href="productbundle.jsp" title="">Product Bundle</a></li>
				<li><a href="pricelevel.jsp">Price Level</a></li>
				<li><a href="#">Price List</a></li>
            ...
            <div>
            	...
            	<div id='content' style="margin-top:0px;">
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='warehousedepot' style='visibility: hidden;'>
												<ul>
													<li>
														<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="pricelist/createditpricelist.jsp" target="_newtab">&nbsp;Price List</a>
													</li>
												</ul>
											</div>
											<br/>
						...
						<div id="pricelistgrid" style="margin-top:-15px;"></div> 
