...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/inventoryactstkmenu.js"></script>

	<script type="text/javascript" src="inventoryactualstock/inventoryactstk-grid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="#">Inventory Actual Stock</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='inventactstkmenu'>
            <ul>
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='invrecp' style='visibility: hidden;'>
												<ul>
													<li>
															<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="inventoryactualstock/createditactualstock.jsp" target="_newtab">&nbsp;Product Stock</a>
													</li>
