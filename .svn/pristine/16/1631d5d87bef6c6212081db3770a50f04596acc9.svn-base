...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/productcategorymenu.js"></script>
	
	
	<script type="text/javascript" src="productcategory/prodcategorygrid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='categorymenu'>
            <ul>
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='warehousedepot' style='visibility: hidden;'>
												<ul>
													<li>
														<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="productcategory/createditprodcat.jsp" target="_newtab">&nbsp;Product Category</a>
													</li>
												</ul>
											</div>
											<br/>
