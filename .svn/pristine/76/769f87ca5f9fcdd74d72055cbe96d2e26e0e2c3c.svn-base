         ...
         $(document).ready(function () {
             ...
             var source =
            {
                ...
                [
                    ...
                    { name: 'bookinguom', type: 'string' },
                    { name: 'bookinglocation', type: 'string' },
            ...
            $("#warehousegrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Booking Name', editable: false, datafield: 'bookingname', width: 240, rendered: tooltiprenderer },
                  { text: 'Booking date', editable: false, datafield: 'bookingdate', width: 200, rendered: tooltiprenderer },
                  { text: 'Booking UOM', editable: false, datafield: 'bookinguom', width: 200, rendered: tooltiprenderer },
                  { text: 'Location', editable: false, datafield: 'bookinglocation',width: 200, rendered: tooltiprenderer},
				  { text: 'Booking Type', editable: false, datafield: 'bookingtype', width: 200, rendered: tooltiprenderer }
