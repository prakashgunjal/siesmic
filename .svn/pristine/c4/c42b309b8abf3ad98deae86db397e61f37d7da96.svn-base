...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/projectmilemenu.js"></script>
	
	
	<script type="text/javascript" src="projectmilestone/projectmile-grid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="#">Project Milestone</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='projectmilemenu'>
            <ul>
               		...
               		<div id='content' style="margin-top:0px;">
								<script type="text/javascript">
									$(document).ready(function () {
										...
										// Create a jqxMenu
										$("#projectmile").jqxMenu({ width: '99.8%', height: '30px', theme: theme });
										$("#projectmile").css('visibility', 'visible');    
									});
								</script>
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='projectmile' style='visibility: hidden;'>
												<ul>
													<li>
															<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="projectmilestone/createditprojectmilestone.jsp" target="_newtab">&nbsp;Project Milestone</a>
													</li>
												</ul>
											</div>
											<br/>
						...
						<div id="projectmilegrid" style="margin-top:-15px;"></div>		
            </div>
            <div>
