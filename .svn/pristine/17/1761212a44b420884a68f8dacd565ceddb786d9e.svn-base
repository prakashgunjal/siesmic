...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="assetmovementmenujs/assetmovementmenu.js"></script>
	
	
	<script type="text/javascript" src="assetmovement-grid.js"></script>
    <script type="text/javascript" src="../../extjs/include-ext.js"></script>
   
 
	<script type="text/javascript" src="assetmovement-form.js"></script>
	<script type="text/javascript" src="inventoryassetserialize-grid.js"></script>
	
	<script type="text/javascript" src="../../commongrid/commonproductgrid.js"></script>
	<script type="text/javascript" src="../../commongrid/commonmovementgrid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="#">New Asset Movement</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='margin-top:5px;' id='assetmenu'>
            <ul>
            	
                <li>Products</li>
            </ul>
            <div>								
					 <div id="serialprodgrid"></div>  
            </div>          
