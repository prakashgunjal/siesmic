...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="prod-bundle-form.js"></script>
	<script type="text/javascript" src="prodbundetailgrid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="../productbundle.jsp">Product Bundle</a></li>
			<li><a href="#">New Product Bundle</a></li>
        </ul>
        ...
        <div class="dashRow">
            ...
            <div class="row-fluid">
              <div class="span12" style="margin-top:5px; margin-left:0px;">
				...
				<div id="formprodbundle"></div>
			 <div id="bundledetail" style="margin-top:0px;"></div>
