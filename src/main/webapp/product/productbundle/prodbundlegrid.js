         ...
         $(document).ready(function () {
             ...
             var source =
            {
                ...
                [
                    ...
                    { name: 'prodbundname', type: 'string' },
                    { name: 'discount', type: 'date' },
                    { name: 'wholesalerate', type: 'date' },
            ...
            $("#warehousegrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Location Name', editable: false, datafield: 'prodname', width: 240, rendered: tooltiprenderer },
                  { text: 'Site Name', editable: false, datafield: 'prodbundname', width: 200, rendered: tooltiprenderer },
                  { text: 'Premises Name', editable: false, datafield: 'discount', width: 200, rendered: tooltiprenderer },
                  { text: 'Premises Wing Name', editable: false, datafield: 'wholesalerate',width: 200, rendered: tooltiprenderer},
				  { text: 'Premises Location', editable: false, datafield: 'retailrate', width: 200, rendered: tooltiprenderer }
