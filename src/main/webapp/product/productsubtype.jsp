...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/productsubtypemenu.js"></script>	
	
	<script type="text/javascript" src="productsubtype/prodsubtypegrid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="#">Product Sub-Type</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='prodsubtypemenu'>
            <ul>
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='warehousedepot' style='visibility: hidden;'>
												<ul>
													<li>
														<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="productsubtype/createditproductsubtype.jsp" target="_newtab">&nbsp;Product Sub-Type</a>
													</li>
												</ul>
											</div>
											<br/>
