...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/productpricelevelmenu.js"></script>
	
	
	<script type="text/javascript" src="pricelevel/pricelevelgrid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='prodpricelevelmenu'>
            <ul>
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='warehousedepot' style='visibility: hidden;'>
												<ul>
													<li>
														<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="pricelevel/createditpricelevel.jsp" target="_newtab">&nbsp;Price Level</a>
													</li>
												</ul>
											</div>
											<br/>
