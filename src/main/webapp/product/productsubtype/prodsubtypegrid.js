         ...
         $(document).ready(function () {
            ...
            $("#warehousegrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Product Type', editable: false, datafield: 'prodtype', width: 240, rendered: tooltiprenderer },
                  { text: 'Product Sub-Type', editable: false, datafield: 'prodsubtype', width: 200, rendered: tooltiprenderer },
