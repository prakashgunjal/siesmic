...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/prodmenu.js"></script>
	
	
	<script type="text/javascript" src="products/prodgrid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='prodsubmenu'>
            <ul>
               	<li><a href="#" title="project">Product</a></li>
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='warehousedepot' style='visibility: hidden;'>
												<ul>
													<li>
														<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="products/createditproduct.jsp" target="_newtab">&nbsp;Product</a>
													</li>
												</ul>
											</div>
											<br/>
