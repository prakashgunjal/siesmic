                                ...
                                if (this.editcell == null) {
                                    if (cell.rowindex + 1 < this.dataview.totalrecords) {
                                        if (this.sortcolumn != cell.datafield) {
                                            ...
                                            if (visiblerow) {
                                                if (!this.pageable || (this.pageable && visibleindex + 1< this.pagesize)) {
                                                    this.clearselection(false);
                                                    this.selectcell(visiblerow.boundindex, cell.datafield);
                                            ...
                                            if (oldselectedcell != null) {
                                                ...
                                                if (oldvisiblerow) {
                                                    if (!this.pageable || (this.pageable && oldvisibleindex + 1 < this.pagesize)) {
                                                        this.clearselection(false);
                                                        this.selectcell(oldvisiblerow.boundindex, cell.datafield);
                                                    }
                ...
                case "datetimeinput":
                    if (this.host.jqxDateTimeInput) {
                        ...
                        if (dateeditor == undefined) {
                            ...
                            editor.jqxDateTimeInput({localization: localization, _editor: true, theme: this.theme, rtl: this.rtl, width: $element.width(), height: $element.height(), formatString: column.cellsformat });
        ...
        _geteditorvalue: function (column) {
            ...
            if (this.editcell.editor) {
                switch (column.columntype) {
                    ...
                    default:
                        ...
                        if (column.cellsformat != "") {
                            ...
                            if (column.cellsformat.indexOf('H') != -1 || column.cellsformat.indexOf('m') != -1 || column.cellsformat.indexOf('M') != -1 || column.cellsformat.indexOf('y') != -1
                ...
                if (column.geteditorvalue) {
                    value = column.geteditorvalue(this.editcell.row, this.editcell.value, this.editcell.editor);
                }
            }
            return value;
        },
