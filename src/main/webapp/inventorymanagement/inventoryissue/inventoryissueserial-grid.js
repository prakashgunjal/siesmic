            ...
            $("#bookserialgrid").jqxGrid(
            {
               ...
               renderstatusbar: function (statusbar) {
                   ...
                   deleteButton.click(function (event) {
                       var selectedrowindex = $("#bookserialgrid").jqxGrid('getselectedrowindex');
                       var rowscount = $("#bookserialgrid").jqxGrid('getdatainformation').rowscount;
                       if (selectedrowindex >= 0 && selectedrowindex < rowscount) {
                           var id = $("#bookserialgrid").jqxGrid('getrowid', selectedrowindex);
                           $("#bookserialgrid").jqxGrid('deleterow', id);
                       }
                   });
               },
            });
