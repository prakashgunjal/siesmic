         ...
         $(document).ready(function () {
             ...
             var source =
            {
                ...
                [
                    ...
                    { name: 'issuetype', type: 'date' },
                    { name: 'issueloc', type: 'date' },
					{ name: 'issuestart', type: 'string' },
					{ name: 'issueend', type: 'date' }
            ...
            $("#intprogrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Issue Name', editable: false, datafield: 'issuename', width: 240, rendered: tooltiprenderer },
                  { text: 'Issue ID', editable: false, datafield: 'issuedate', width: 200, rendered: tooltiprenderer },
                  { text: 'Issue Type', editable: false, datafield: 'issuetype', width: 200, rendered: tooltiprenderer },
                  { text: 'Issue Location', editable: false, datafield: 'issueloc',width: 200, rendered: tooltiprenderer},
				  { text: 'Issue Start Date', editable: false, datafield: 'issuestart', width: 200, rendered: tooltiprenderer },
                  { text: 'Issue End Date', editable: false, datafield: 'issueend', width: 200, rendered: tooltiprenderer }	  
               ],
            ...
            $("#intprogrid").on('pagechanged', function (event) {
             ...
             $("#intprogrid").on('contextmenu', function () {
                 return false;
             });
             ...
             $("#Menu").on('itemclick', function (event) {
                 var args = event.args;
                 var rowindex = $("#intprogrid").jqxGrid('getselectedrowindex');
                 if ($.trim($(args).text()) == "Edit Selected Row") {
                     editrow = rowindex;
                     var offset = $("#intprogrid").offset();
                     $("#popupWindow").jqxWindow({ position: { x: parseInt(offset.left) + 60, y: parseInt(offset.top) + 60} });

                     // get the clicked row's data and initialize the input fields.
                     var dataRecord = $("#intprogrid").jqxGrid('getrowdata', editrow);
                     ...
                     var rowid = $("#intprogrid").jqxGrid('getrowid', rowindex);
                     $("#intprogrid").jqxGrid('deleterow', rowid);
                 }
             });
 			
 			$("#intprogrid").on('rowclick', function (event) {
