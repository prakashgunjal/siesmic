         ...
         $(document).ready(function () {
            ...
            $("#warehousegrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Asset Account Name', editable: false, datafield: 'assetaccnme', width: 200, rendered: tooltiprenderer },
                  { text: 'In Date', editable: false, datafield: 'indate', width: 200, rendered: tooltiprenderer },
                  { text: 'Out Date', editable: false, datafield: 'outdate', width: 200, rendered: tooltiprenderer },
                  { text: 'Product Name', editable: false, datafield: 'productnames',width: 200, rendered: tooltiprenderer},
				  { text: 'Product Types', editable: false, datafield: 'producttype', width: 200, rendered: tooltiprenderer },
				  { text: 'Order Name', editable: false, datafield: 'ordername', width: 200, rendered: tooltiprenderer },
				  { text: 'Location', editable: false, datafield: 'location', width: 200, rendered: tooltiprenderer }
