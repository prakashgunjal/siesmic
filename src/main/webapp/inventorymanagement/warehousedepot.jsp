...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="warehouselocation/warehouse-grid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="#">Warehouse & Depot</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='warehousemenu'>
            <ul>
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='warehousedepot' style='visibility: hidden;'>
												<ul>
													<li>
														<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="warehouselocation/createwarehouse/createwarehousedepot.jsp" target="_newtab">&nbsp;Warehouse</a>
													</li>
