...
<meta charset="utf-8">
	...
	<link rel="stylesheet" href="../jqwidgets/styles/jqx.metro-dark.css" type="text/css" />
	...
	<script type="text/javascript" src="../menujs/inventoryreceipt-menu.js"></script>
	
	
	<script type="text/javascript" src="inventoryreceipts/inventoryreceipt-grid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="#">Inventory Receipts</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='invenrecpmenu'>
            <ul>
            	      
                <li><a href="#">Inventory Receipts</a></li>
                <li><a href="inventorybooking.jsp" title="">Inventory Booking</a></li>
                <li><a href="inventoryactualstock.jsp">Inventory Actual Stock</a></li>
                <li><a href="inventoryissue.jsp">Inventory Issue</a></li>
               	<li><a href="purchaseorder.jsp">Purchase Order</a></li>
               	<li><a href="assetmovement.jsp">Asset Movement</a></li>
               	<li><a href="warehousedepot.jsp" title="project">Warehouse & Depot</a></li>
					...
					<div id='content' style="margin-top:0px;">
								<script type="text/javascript">
									$(document).ready(function () {
										...
										// Create a jqxMenu
										$("#invrecp").jqxMenu({ width: '99.8%', height: '30px', theme: theme });
										$("#invrecp").css('visibility', 'visible');    
									});
								</script>

										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='invrecp' style='visibility: hidden;'>
												<ul>
													<li>
															<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="inventoryreceipts/createditinventoryreceipt.jsp" target="_newtab">&nbsp;Inventory Receipt</a>
													</li>
												</ul>
											</div>
											<br/>
						...
						<div id="inventreciepgrid" style="margin-top:-15px;"></div>								
