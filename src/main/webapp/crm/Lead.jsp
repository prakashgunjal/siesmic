...
<meta charset="utf-8">
   ...
   <link rel="stylesheet" href="../css/seismic-all.css" type="text/css" media="all"/>
	...
	<script type="text/javascript" src="Lead/Leadmenu.js"></script>
	
	<script type="text/javascript" src="../gridjs/leadgrid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:5px;' id='Leadmenu'>
            <ul>
            ...
            <div>
               		...
               		<div id='content' style="margin-top:0px;">
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='leadmenu' style='visibility: hidden;'>
												<ul>
													<li><img src="../image/plus.png" style="height:20px; width:20px;"/><a href="Lead/createditlead.jsp" target="_newcrm" >&nbsp;Lead</a></li>
												</ul>
											</div>
											<br/>
										</div>
						...
						<div id="leadgrid" style="margin-top:-15px;"></div>			
            </div>
            <div>
