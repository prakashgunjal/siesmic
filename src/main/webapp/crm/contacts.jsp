...
<script type="text/javascript" src="contacts/contactmenu.js"></script>

<script type="text/javascript" src="../gridjs/contacts-grid.js"></script>
									...
									<div id='jqxWidget'>
										<div style='float: left; margin-left: 0px; margin-top: -5px;'
											...
											<div>
														...
														<div id='leadmenu' style='visibility: hidden;'>
															<ul>
																<li><img src="../image/plus.png"
																	...
																	href="contacts/createditcontacts.jsp" target="_newcrm">Contact</a>
												...
												<div id="contactsgrid" style="margin-top: -15px;"></div>
											</div>
											<div></div>
											<div></div>
											<div></div>
