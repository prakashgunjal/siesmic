         ...
         $(document).ready(function () {
            ...
            $("#contragrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Start Date', editable: false, datafield: 'stdate', width: '20%', rendered: tooltiprenderer },
				  { text: 'End Date Date', editable: false, datafield: 'edate', width: '20%', rendered: tooltiprenderer }
            ...
            $("#contragrid").on('pagechanged', function (event) {
             ...
             $("#contragrid").on('contextmenu', function () {
                 return false;
             });
             ...
             $("#Menu").on('itemclick', function (event) {
                 var args = event.args;
                 var rowindex = $("#contragrid").jqxGrid('getselectedrowindex');
                 if ($.trim($(args).text()) == "Edit Selected Row") {
                     editrow = rowindex;
                     var offset = $("#contragrid").offset();
                     $("#popupWindow").jqxWindow({ position: { x: parseInt(offset.left) + 60, y: parseInt(offset.top) + 60} });

                     // get the clicked row's data and initialize the input fields.
                     var dataRecord = $("#contragrid").jqxGrid('getrowdata', editrow);
                     ...
                     var rowid = $("#contragrid").jqxGrid('getrowid', rowindex);
                     $("#contragrid").jqxGrid('deleterow', rowid);
                 }
             });
 			
 			$("#contragrid").on('rowclick', function (event) {
