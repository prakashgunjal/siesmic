...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="projecttaskmenujs/projecttaskmenu.js"></script>
	
	
	<script type="text/javascript" src="projecttask-grid.js"></script>
     <script type="text/javascript" src="../../extjs/include-ext.js"></script>

 
	<script type="text/javascript" src="projecttask-form.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="../projecttask.jsp">Project Task</a></li>
			<li><a href="#">New Project Task</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='projecttaskmenu'>
            ...
            <div>
                	<div id="commonmeetgrid" style="margin-top:0px;"></div>
            </div>
