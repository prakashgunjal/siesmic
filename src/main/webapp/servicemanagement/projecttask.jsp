...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/projecttaskmenu.js"></script>
	
	
	<script type="text/javascript" src="projecttask/projecttask-grid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='projecttaskmenu'>
            <ul>
                ...
                <li><a href="projectmanagement.jsp">Project Time Sheet</a></li>
            ...
            <div>
                ...
                <div id='content' style="margin-top:0px;">
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='projectmgmt' style='visibility: hidden;'>
												<ul>
													<li>
															<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="projecttask/createditprojecttask.jsp" target="_newtab">&nbsp;Project Task</a>
													</li>
												</ul>
											</div>
											<br/>
						...
						<div id="projecttaskgrid" style="margin-top:-15px;"></div>
            </div>
            <div>
