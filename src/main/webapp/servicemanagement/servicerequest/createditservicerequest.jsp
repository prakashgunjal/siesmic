...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="servicemenujs/servicemenu.js"></script>

    <script type="text/javascript" src="../../extjs/include-ext.js"></script>

 
	<script type="text/javascript" src="servreq-form.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:5px;' id='servicemenu'>
            <ul>   
                <li>Sales Order</li>
