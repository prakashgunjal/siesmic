...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/projectmgmtmenu.js"></script>
	
	
	<script type="text/javascript" src="projectmanagement/projectmgmt-grid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="#">Project Timesheet</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='projectmgmtmenu'>
            <ul>
            	<li><a href="servicerequest.jsp">Service Request</a></li>
                <li><a href="project.jsp" title="project">Project</a></li>
                <li><a href="projectmilestone.jsp">Project Milestone</a></li>
                <li><a href="projecttask.jsp" title="">Project Task</a></li>
                <li><a href="#">Project Time Sheet</a></li>
                <li><a href="expensemanagement.jsp">Expense Management</a></li>
                ...
                <div id='content' style="margin-top:0px;">
								<script type="text/javascript">
									$(document).ready(function () {
										...
										// Create a jqxMenu
										$("#projectmgmt").jqxMenu({ width: '99.8%', height: '30px', theme: theme });
										$("#projectmgmt").css('visibility', 'visible');    
									});
								</script>
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='projectmgmt' style='visibility: hidden;'>
												<ul>
													<li>
														<img src="../image/plus.png" height="20px" width="20px"/><a href="projectmanagement/createditprojectmgmt.jsp" target="_newtab">&nbsp;Project Time Sheet</a>
													</li>
												</ul>
											</div>
											<br/>
						...
						<div id="projectmgmtgrid" style="margin-top:-15px;"></div>
            </div>
            <div>
