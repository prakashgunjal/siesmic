...
public class GeneralActivityController {
	...
	ExtJSResponse saveGeneralActivityData(
		...
		System.out.println("In saveGeneralActivityData>>>>>>>>>>>>>>>>>>>>>>>>>>>"+generalActivityId);
		String message;	 
		...
		if (generalActivityId == null) {
			...
			System.out.println("=========creating new generalActivities============");
		} else {
			generalActivities = this.generalActivityRepository.findOne(generalActivityId);
			System.out.println("========updating generalActivities========="+ generalActivityId);
		}
...
//		generalActivities.setGeneralActivityEntityName(generalActivityEntityName);
		...
		if(generalActivityAssignedTo!=null ){
...
//		generalActivities.setGeneralActivityDate(new CustomDateUtil().getCustomDateAndTime(generalActivityDate));
		...
		if(generalActivityId==null ){          			
		    message= MessagesUtil.showMessage("Activity", entityNumber,  "Created" , "Successfully" ) ;			
	    }else{					
			message= MessagesUtil.showMessage("Activity", entityNumber,  "Updated" , "Successfully" ) ;
	    }		
		GeneralActivities newGeneralActivities = generalActivityService.saveGeneralActivitiess(generalActivities);
			
		return new ExtJSResponse(true , newGeneralActivities, message ); 
	}
