         ...
         $(document).ready(function () {
            ...
            {              
            	datatype: "json",   
            	url : basePath+'quote/' + quoteId + '/salesFormListPerQuote.json',  
            ...
            $("#commonsalesgrid").jqxGrid(
            {
               ...
               renderstatusbar: function (statusbar) {
                   ...
                   addButton.click(function (event) {
                	     ...
                	     newwindow=window.open('../../crm/salesformsdetails/coverQuotes.htm?accountId='+accountId+"&quoteId="+quoteId,'_parent','height=400,width=1000');  
                   ...
                   editButton.click(function (event) {                 	   
                       ...
                       if(dataRecord!=null){
                         ...
                         window.open('../../crm/salesformsdetails/coverQuotesEdit.htm?salesOrderId='+salesOrderId+ "&quoteId="+quoteId,'_parent','height=400,width=1000');          	   
                       }else{
