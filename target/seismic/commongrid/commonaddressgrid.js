         $(document).ready(function () {
            ...
            $("#commonaaddressgrid").jqxGrid(
            {
                ...
                width:1342,
                columns: [
                  { text: 'Type', editable: false, datafield: 'listValueDescription', width: 200, rendered: tooltiprenderer },                 
               ...
               renderstatusbar: function (statusbar) {
                   ...
                   addButton.click(function (event) {
                	   var newwindow;                	   
                	   window.open("../../commonjsppages/address/address.htm?contactId=" + contactId+"&url="+location.href  , name="_parent");                	                     	
                   ...
                   editButton.click(function (event) {
                        ...
                        window.open("../../commonjsppages/address/address.htm?addressId=" + addId+"&url="+location.href , name="_parent");
                        }else{
