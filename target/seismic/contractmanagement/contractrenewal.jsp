...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="contractrenewal/contractrenewmenujs/contractrenewalmenu.js"></script>
	
	
	<script type="text/javascript" src="contractrenewal/contractrenewal-grid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="#">Contracts Renewal</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='float: left; margin-left:0px; margin-top:-5px;' id='contractrenewmenu'>
            <ul style="margin-left: 30px;">
            	
                <li><a href="contract.jsp">Contracts</a></li>
                <li><a href="#">Contract Renewal</a></li>
              ...
              <div id='content' style="margin-top:0px;">
								<script type="text/javascript">
									$(document).ready(function () {
										...
										// Create a jqxMenu
										$("#contrarenewmenu").jqxMenu({ width: '99.8%', height: '30px', theme: theme });
										$("#contrarenewmenu").css('visibility', 'visible');    
									});
								</script>
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='contrarenewmenu' style='visibility: hidden;'>
												<ul>
													<li><img src="../image/plus.png" style="height:20px; width:20px;"/><a href="contractrenewal/createditcontractrenew.jsp" target="_newtab">&nbsp;Renew Contract </a></li>
												</ul>
											</div>
											<br/>
										</div>
				...
				<div id="contrarenewgrid" style="margin-top:-15px;"></div>
            </div>
