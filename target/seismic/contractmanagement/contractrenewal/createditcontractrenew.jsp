...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="contractrenewmenujs/contractrenewmenu.js"></script>
	
	
     <script type="text/javascript" src="../../extjs/include-ext.js"></script>
 
	<script type="text/javascript" src="contractrenewal-form.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:5px;' id='contractrenewmenus'>
            <ul>
