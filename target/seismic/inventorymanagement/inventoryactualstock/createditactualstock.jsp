...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="actualstockmenujs/actualstockmenu.js"></script>
	
	
	<script type="text/javascript" src="inventoryactstk-grid.js"></script>
     <script type="text/javascript" src="../../extjs/include-ext.js"></script>
 
 
	<script type="text/javascript" src="inventoryactualstock-form.js"></script>
	<script type="text/javascript" src="inventoryactualserialize-grid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="#">New inventory Actual Stock</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='margin-top:5px;' id='actualstockmenu'>
            <ul>
