            ...
            $("#serialprodgrid").jqxGrid(
            {
               ...
               renderstatusbar: function (statusbar) {
                   ...
                   deleteButton.click(function (event) {
                       var selectedrowindex = $("#serialprodgrid").jqxGrid('getselectedrowindex');
                       var rowscount = $("#serialprodgrid").jqxGrid('getdatainformation').rowscount;
                       if (selectedrowindex >= 0 && selectedrowindex < rowscount) {
                           var id = $("#serialprodgrid").jqxGrid('getrowid', selectedrowindex);
                           $("#serialprodgrid").jqxGrid('deleterow', id);
                       }
                   });
               },
            });
