...
<meta charset="utf-8">
   ...
   <link rel="stylesheet" href="../css/seismic-all.css" type="text/css" media="all"/>
	...
	<script type="text/javascript" src="../menujs/inventoryissuemenu.js"></script>
	
	
	<script type="text/javascript" src="inventoryissue/inventoryissue-grid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="#">Inventory Issues</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='inventoryissue'>
            <ul>
            ...
            <div>
                ...
                <div id='content' style="margin-top:0px;">
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='warehousedepot' style='visibility: hidden;'>
												<ul>
													<li>
															<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="inventoryissue/createditinventoryissue.jsp" target="_newtab">&nbsp;Inventory Issue</a>
													</li>
						...
						<div id="intprogrid" style="margin-top:-15px;"></div>
            </div>
            <div>
