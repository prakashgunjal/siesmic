...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/inventorybooking.js"></script>
	
	
	<script type="text/javascript" src="inventorybooking/inventorybooking-grid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="#">Inventory Booking</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='inventbookmenu'>
            <ul>
                <li><a href="inventoryreceipt.jsp">Inventory Receipts</a></li>
                <li><a href="#" title="">Inventory Booking</a></li>
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='invrecp' style='visibility: hidden;'>
												<ul>
													<li>
															<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="inventorybooking/createditinventorybooking.jsp" target="_newtab">&nbsp;Inventory Booking</a>
													</li>
												</ul>
											</div>
											<br/>
