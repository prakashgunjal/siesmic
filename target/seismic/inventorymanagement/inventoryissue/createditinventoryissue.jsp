...
<meta charset="utf-8">
   ...
   <link rel="stylesheet" href="../../css/seismic-all.css" type="text/css" media="all"/>
	...
	<script type="text/javascript" src="inventoryissuemenujs/inventoryissuemenu.js"></script>
	
     <script type="text/javascript" src="../../extjs/include-ext.js"></script>
 
	<script type="text/javascript" src="inventoryissue-form.js"></script>
	<script type="text/javascript" src="inventoryissueserial-grid.js"></script>
    ...
    <div id="view-holder" class="ui-layout-content">
      <div class="scroll-pane">
        <ul class="breadcrumb">
			...
			<li><a href="#">New inventory Issue</a></li>
        </ul>
...
<div id='jqxWidget'>
        <div style='margin-top:5px;' id='inventoryissuesmenu'>
            <ul>
