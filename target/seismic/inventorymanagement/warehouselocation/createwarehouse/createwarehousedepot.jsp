...
<meta charset="utf-8">
   ...
   <link rel="stylesheet" href="../../../css/bootstrap.min.css" type="text/css" media="all"/>
	...
	<script type="text/javascript" src="site-form.js"></script>
	<script type="text/javascript" src="premises-form.js"></script>
	<script type="text/javascript" src="premiseswing-form.js"></script>
	<script type="text/javascript" src="premiselocation-form.js"></script>
	<script type="text/javascript" src="premisesection-form.js"></script>
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxlocexpand").jqxExpander({ width: '98%', theme: theme });
        });
 </script>
 <script type="text/javascript">
        $(document).ready(function () {
            // Create jqxExpander
            var theme = getDemoTheme();
            $("#jqxsite").jqxExpander({ width: '98%', theme: theme });
        });
 </script>
 <script type="text/javascript">
        $(document).ready(function () {
            // Create jqxExpander
            var theme = getDemoTheme();
            $("#jqxpremises").jqxExpander({ width: '98%', theme: theme });
        });
 </script>
 <script type="text/javascript">
        $(document).ready(function () {
            // Create jqxExpander
            var theme = getDemoTheme();
            $("#jqxprewing").jqxExpander({ width: '98%', theme: theme });
        });
 </script>
 <script type="text/javascript">
        $(document).ready(function () {
            // Create jqxExpander
            var theme = getDemoTheme();
            $("#jqxpreloc").jqxExpander({ width: '98%', theme: theme });
        });
 </script>
 <script type="text/javascript">
        $(document).ready(function () {
            // Create jqxExpander
            var theme = getDemoTheme();
            $("#jqxpresection").jqxExpander({ width: '98%', theme: theme });
        });
 </script>
                ...
                <ul>    
                        ...
                        <div id="sub1" class="accordion-body collapse">
                          <div class="accordion-inner">
                              <ul>
                                <li class=""><a href=""><p>Dashboard</p></a></li>
								<li class=""><a href=""><p>Alerts</p></a></li>
								<li class=""><a href=""><p>Reports</p></a></li>
								<li class=""><a href=""><p>Database Integration</p></a></li>
                              </ul>
        ...
        <div class="dashRow">
            <div class="row-fluid">
              ...
              <div class="span12" style="margin-top:5px;">
				...
				<div id='jqxlocexpand' style="margin-top:0px; margin-left:0px;">
				<div>Locations</div>
				...
				<form id="savesite">
				<div id='jqxsite' style="margin-top:0px; margin-left:0px;">
				<div>Site</div>
				...
				<form id="savepremises">
				<div id='jqxpremises' style="margin-top:0px; margin-left:0px;">
				<div>Premises</div>
				<div id="formpremises">
				...
				<form id="saveprewing">
				<div id='jqxprewing' style="margin-top:0px; margin-left:0px;">
				<div>Premises Wing</div>
				<div id="formpremiseswing">
					
				</div>
			 	</div>
				</form>
                 
                 <form id="saveprelocation">
				<div id='jqxpreloc' style="margin-top:0px; margin-left:0px;">
				<div>Premises Location</div>
				<div id="formpremisesloc">
					
				</div>
			 	</div>
				</form>    
				
				<form id="savepresection">
				<div id='jqxpresection' style="margin-top:0px; margin-left:0px;">
				<div>Premises Section</div>
				<div id="formpremisessec">
