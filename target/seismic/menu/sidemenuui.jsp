                        ...
                        <div id="sub3" class="accordion-body collapse">
                          <div class="accordion-inner">
                              <ul>
                                ...
                                <li class=""><a href="${pageContext.request.contextPath}/crm/Lead.jsp"><p>Lead</p></a></li>
                                ...
                                <li class=""><a href="${pageContext.request.contextPath}/crm/salesorder.jsp"><p>Sales Order</p></a></li>
                              </ul>
