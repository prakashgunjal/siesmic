...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="expensemenujs/expensemenu.js"></script>
	
	
	<script type="text/javascript" src="expensemgmt-grid.js"></script>
    <script type="text/javascript" src="../../extjs/include-ext.js"></script>
 
	<script type="text/javascript" src="expensemanag-form.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:5px;' id='expensemenu'>
            <ul>
            	<li>Documents</li>
