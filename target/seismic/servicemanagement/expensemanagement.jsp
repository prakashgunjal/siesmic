...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/expensemgmtmenu.js"></script>
	
	
	<script type="text/javascript" src="expensemanagement/expensemgmt-grid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='expensemenu'>
            <ul>
            ...
            <div>
                ...
                <div id='content' style="margin-top:0px;">
									...
									$(document).ready(function () {
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='expensemgmt' style='visibility: hidden;'>
												<ul>
													<li>
															<img src="../image/plus.png" height="20px" width="20px"/><a href="expensemanagement/createditexpensemanagement.jsp" target="_newtab">&nbsp;Expense</a>
													</li>
												</ul>
											</div>
											<br/>
						...
						<div id="expensegrid" style="margin-top:-15px;"></div>
            </div>
