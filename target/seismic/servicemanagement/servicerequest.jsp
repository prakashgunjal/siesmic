...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/servicereq.js"></script>
	
	
	<script type="text/javascript" src="servicerequest/servicereq-grid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='servicereqmenu'>
            <ul>   
                <li><a href="#">Service Request</a></li>
					...
					<div id='content' style="margin-top:0px;">
								<script type="text/javascript">
									$(document).ready(function () {
										...
										// Create a jqxMenu
										$("#expensemgmt").jqxMenu({ width: '99.8%', height: '30px', theme: theme });
										$("#expensemgmt").css('visibility', 'visible');    
									});
								</script>
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='expensemgmt' style='visibility: hidden;'>
												<ul>
													<li>
															<img src="../image/plus.png" height="20px" width="20px"/><a href="servicerequest/createditservicerequest.jsp" target="_newtab">&nbsp;Service Request</a>
													</li>
												</ul>
											</div>
											<br/>
						...
						<div id="servicereqgrid" style="margin-top:-15px;"></div>		
