...
<meta charset="utf-8">
	...
	<script type="text/javascript" src="../menujs/projectmenu.js"></script>
	
	
	<script type="text/javascript" src="project/project-grid.js"></script>
...
<div id='jqxWidget'>
        <div style='margin-top:0px;' id='projectmenu'>
            <ul>
					...
					<div id='content' style="margin-top:0px;">
								<script type="text/javascript">
									$(document).ready(function () {
										...
										// Create a jqxMenu
										$("#project").jqxMenu({ width: '99.8%', height: '30px', theme: theme });
										...
										<div id='jqxWidget' style='margin-top:0px; '>
											<div id='project' style='visibility: hidden;'>
												<ul>
													<li>
															<img src="../image/plus.png" style="height:20px; width:20px;"/><a href="project/createditproject.jsp" target="_newtab">&nbsp;Project</a>
													</li>
												</ul>
											</div>
											<br/>
						...
						<div id="projectgrid" style="margin-top:-15px;"></div>						
