         ...
         $(document).ready(function () {
             ...
             var source =
            {
                ...
                [
                    ...
                    { name: 'prodnumber', type: 'string' },
                    { name: 'prodcat', type: 'date' },
                    { name: 'prodsubcat', type: 'date' },
					{ name: 'prodwholerate', type: 'string' },
                    { name: 'prodretailrate', type: 'string' }
            ...
            $("#warehousegrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Product Number', editable: false, datafield: 'prodnumber', width: 200, rendered: tooltiprenderer },
                  { text: 'Product Category', editable: false, datafield: 'prodcat', width: 200, rendered: tooltiprenderer },
                  { text: 'Product Sub-category', editable: false, datafield: 'prodsubcat',width: 200, rendered: tooltiprenderer},
				  { text: 'Product Wholesale Rate', editable: false, datafield: 'prodwholerate', width: 200, rendered: tooltiprenderer },
				  { text: 'Product Retail Rate', editable: false, datafield: 'prodretailrate', width: 200, rendered: tooltiprenderer }
