         ...
         $(document).ready(function () {
             ...
             var source =
            {
                ...
                [
                    ...
                    { name: 'terrname', type: 'string' },
                    { name: 'currency', type: 'date' },
            ...
            $("#warehousegrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Product Name', editable: false, datafield: 'prodname', width: 240, rendered: tooltiprenderer },
                  { text: 'Territory Name', editable: false, datafield: 'terrname', width: 200, rendered: tooltiprenderer },
                  { text: 'Currency', editable: false, datafield: 'currency', width: 200, rendered: tooltiprenderer },
